...
Depends on TASK-91/92/94 because they reword the very clauses the new anchors pin — anchor the settled prose (the runbook-authoring precedent: tests pin prose after it lands).
