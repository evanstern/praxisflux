...
RENUMBERED from TASK-108 on 2026-09-01 by operator decision: this card was created on main as TASK-108 (commit a6e9e68) but that id was already held by the board-provider-seam epic, so the backlog CLI silently resolved only the epic and THIS card was invisible to the board. Content preserved verbatim from the original; the shadowed duplicate is archived.
