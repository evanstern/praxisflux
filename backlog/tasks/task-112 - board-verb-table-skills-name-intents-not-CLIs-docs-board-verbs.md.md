...
spec-bridge sync: Phase 1 — Enumerate the real call sites, author the verb table: 6/6 · Phase 2 — Mirror labels and the paused-lane fix (correctness, early): 6/6 · Phase 3 — The block render/parse pair and `renderJira`: 8/8 · Phase 4 — The six skill rewrites, labels doc, versions, re-ground: 11/11 — status In Progress → Done
<!-- SECTION:NOTES:END -->
