...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 pdlc:bootstrap either plants a model-tier rubric stub in the grounding it stamps, or detects an absent rubric and tells the operator what to author and where — the choice recorded with its rationale
