...
- [ ] T002 tracked triage record gains the documented machine-findable last-run-at line (full commit id; range end or HEAD-at-scan) (R1)
- [ ] T003 Scope phase gains 'since last triage': resolve newest record's last-run-at → <id>..HEAD, verify it resolves, STOP with a clear message when no prior record / unresolvable (R2)
- [ ] T004 version bumps: refactor-triage skill 0.2.0 → 0.3.0 + marketplace via sync-version.mjs at merge-readiness (R3)
