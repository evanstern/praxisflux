...
- [ ] T002 SKILL.md: step 7 + concurrency doctrine rewritten — pin-carrying branches
...
- [ ] T003 templates/runbook.md: doctrine section mirrors the same split (R1)
- [ ] T004 freshness probe prescribed after every history move, unconditional, both
  files (R2)
- [ ] T005 versions: sweep skill 0.5.0 → 0.6.0; marketplace sync-version 0.27.0 (R3)
