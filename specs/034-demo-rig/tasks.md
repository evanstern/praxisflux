...
- [ ] T006 CI test test/demo-rig.test.mjs: tags + gate matrix + double-generate repeatability; catalog bullet (R6, R8)
- [ ] T007 RUNSHEET.md: 30-minute script with live gate-break, spec-bridge block, live-task thread, triage beat, fallbacks (R5)
