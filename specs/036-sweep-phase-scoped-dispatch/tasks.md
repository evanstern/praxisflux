# 036-sweep-phase-scoped-dispatch — tasks

## Spec

- [x] T000 claim: board TASK-87 → In Progress + spec dir, committed on the task branch
...
- [x] T006 docs/wiki/pdlc-sweep.md re-verified against the diff (NEEDS-REVIEW), amended within budgets, re-pinned; lockstep-staled siblings RE-PIN-ONLY; CAPSULES regenerated if description changed
