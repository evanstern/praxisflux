...
- [ ] T005 gates green in worktree (node --test, check-docs, freshness) + version bump + staled notes re-pinned
- [ ] T006 board finalized (ACs checked, Done, final summary); PR opened
