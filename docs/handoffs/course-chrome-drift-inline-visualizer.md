...
1. **Two same-named skills coexist and the stale one wins unqualified resolution.**
   ...
   `/Users/user/projects/codebase-to-course` (standalone repo, `main` @ `ff8837e`, clean
   ...
   says the source of truth is `~/projects/codebase-to-course` @ `0e3b61a` ("recent
...
1. **Kill the split-brain:** retire or fast-forward `/Users/user/projects/codebase-to-course`
...
- Stale copy: `~/.claude/skills/codebase-to-course` → `/Users/user/projects/codebase-to-course`
