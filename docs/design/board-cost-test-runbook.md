...
| 2026-07-31 | TASK-78 | — | — | in flight | phases: Spec done; Implement+Prove dispatched as one (claude-sonnet-5 via agent def — first sonnet-tier dispatch, recorded grouping call) |
