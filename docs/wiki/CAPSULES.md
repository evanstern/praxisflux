...
Generated by grounding-wiki `scripts/capsules.mjs` at corpus commit 42f0e457bda98735a60b4deacd935f56b50a7a0b.
...
- [[build-plugin]] — implements a handed-off SPEC and returns findings (scaffold split from educate)
  Implementation-leg plugin (scaffold) — picks up a SPEC handed off via .handoff/, builds and verifies it, and returns findings as a response handoff for educate to fold back in.
