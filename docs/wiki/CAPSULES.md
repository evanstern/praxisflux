...
Generated by grounding-wiki `scripts/capsules.mjs` at corpus commit efc4d69f86ca469838bc20306039c4748879ee47.
...
- [[spec-bridge-plugin]] — Backlog.md as the derived kanban view over GitHub Spec Kit specs; one-way derivation, exceeds-blocks gate
  The spec-bridge plugin — Backlog.md as the derived kanban view over GitHub Spec Kit specs, with pure one-way derivation (lib/spec-derive.mjs), link/sync skills, and a Stop-hook gate blocking status that exceeds spec artifacts.
