...
The `research` plugin (v0.1.0) turns research requests into Obsidian-style Markdown "thinking
...
execs `scripts/stop.mjs`. That script runs `runStopHook` from `lib/gate-runner.mjs` with one
